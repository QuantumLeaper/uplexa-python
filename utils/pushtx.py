...
from uplexa.backends.jsonrpc import JSONRPCDaemon
from uplexa.daemon import Daemon
from uplexa.transaction import Transaction
from uplexa import exceptions
...
argsparser.add_argument('daemon_rpc_url', nargs='?', type=url_data, default='127.0.0.1:21061',
